...
const _sampleMetadata = [
  {
    ...
    logoUrl: null,
    matches: [
      { date: '2026-03-01', time: '18:00', opponent: 'TV Amberg',  opponentShort: 'TVA', ownShort: 'NM', result: '72:68', isHome: true,  isNext: false, competition: 'Bezirksliga' },
      { date: '2026-04-20', time: '15:00', opponent: 'Roth',       opponentShort: 'ROT', ownShort: 'NM', result: null,    isHome: false, isNext: true,  competition: 'Bezirksliga', venueName: 'Sporthalle', venueAddress: 'Str. 1, 91154 Roth', opponentLogoUrl: '' },
      { date: '2026-05-10', time: '18:00', opponent: 'Ansbach',    opponentShort: 'ANS', ownShort: 'NM', result: null,    isHome: true,  isNext: false, competition: 'Bezirksliga' },
    ],
    spotlightMatches: [
      { date: '2026-03-01', time: '18:00', opponent: 'TV Amberg', opponentShort: 'TVA', ownShort: 'NM', result: '72:68', isHome: true,  isNext: false, competition: 'Bezirksliga', venueName: '', venueAddress: '', opponentLogoUrl: '' },
      { date: '2026-04-20', time: '15:00', opponent: 'Roth',      opponentShort: 'ROT', ownShort: 'NM', result: null,    isHome: false, isNext: true,  competition: 'Bezirksliga', venueName: 'Sporthalle', venueAddress: 'Str. 1, 91154 Roth', opponentLogoUrl: '' },
    ],
    competitions: [],
  },
